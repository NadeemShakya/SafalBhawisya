...
<body>
			...
			<div class = "mainDiv">
				<div class = "listDiv" style = "height:550px;">
					<div class = "listDivImg">
						<img src="image/vet.jpeg" alt="please_reload">
					</div>
					<div class = "listDivText">
						<h3>Bachelors in Veterinary Medicine</h3>

		                  <span>
                            Veterinary is the branch of science which deals with the study of animals. It is the most prestigious course which is more expensive after a law in the world. The course is for 5 years. In Nepal, It is called as the latest course. Earlier, only fewer students were used to study veterinary science in Nepal. But with its broad scope and importance, it has become the most studied course nowadays. In this present time, many girls are studying this course. In earlier days, people used to study 15 months (JTA) and used to treat the animals. The scopes in Veterinary medicine are as follows:
                            <ul>
                                <li>Can choose to work with the government animal husbandry departments, poultry farms, dairy farms, race clubs, stud farms, sheep and rabbit farms, private and government veterinary hospitals and clinics.</li>
                                <li>Have good demands in wildlife sanctuaries and Zoological parks.</li>
                                <li>Can choose to work with Army and the Border Security Forces for treatment and care of their horses, mules, camels and dogs.</li>
                                <li>Can choose to be a private practitioner such as opening own care centers.</li>
                                <li>Can choose to be a researcher and a developer of drugs, chemicals and bio products particularly antibiotics and vaccines for humans as well as animal use.</li>
                                <li>Can choose to work with the entrepreneurs in manufacturing of animal foods, processing of animal products like meat, milk, etc.</li>
                                <br>

                                <span>The veterinary professionals have got a good scope nationally as well as largely in international scale where the craze for animals is growing tremendously.</span> <br> <br>
                                <b>Personal Skills</b>
                                <li>Needs to have a special place in heart for animals ie. genuine love and compassion for animals.</li>
                                <li>Must understand animal behavior.</li>
                                <li>Must be willing to work in difficult contexts as well as non-working hours.</li>
                                <li>Should have a soothing effect on animals ie. should know to put animals at ease, patience and calm.</li>
                                <li>S/he needs to be extra sensitive because they will be dealing with animals after all.</li>
                            </ul>
                          </span>
					</div>
				</div>  
