...
<body>
			...
			<div class = "mainDiv">
				<div class = "listDiv" style = "height:500px;">
					...
					<div class = "listDivText">
						<h3>B.Sc. Physics</h3>
						<span>
                          The advantageous thing about studying physics is that you can pursue a career in diverse range of fields. Physics has wide range of applications in the practical field of many disciplines. The bachelors in physics lay the groundwork for students to pursue master’s degree and PHD and have careers in research and academia. Physics graduates can have career in vast ranging sectors, some of which are noted below:<br>
                          Careers as research scientist- research field might include astrophysics, particle physics, Nano technology, aerospace, dynamic physics, applied physics, theoretical physics, experimental physics and so many more.<br>
                          <ul>
                              <li>Space careers as an Astronaut</li>
                              <li>Health care industry within areas of radiation, nuclear medicine and building medical technologies alongside biomedical engineers</li>
                              <li>Engineering careers in manufacturing based industries</li>
                              <li>Energy sector as experts in extracting fossil fuels and developing cost effective ways to create renewable energy</li>
                              <li>Geophysicist and meteorological career</li>
                              <li>Technology careers in fields of robotics, nanotech, virtual reality etc.</li>
                              <li>Educators of physics in school and college level</li>
                          </ul>
    
                          But in Nepal, Physcis graduates mostly have teaching careers at the numerous educational institutions and most of the BSc. Physics graduates go on to pursue master’s degree so they can have better opportunities all around the globe.
                        </span> 
