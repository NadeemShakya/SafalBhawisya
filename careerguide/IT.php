			...
			<div class = "mainDiv">
				<div class = "listDiv" style = "height:850px;">
					...
					<div class = "listDivText">
						<h3>IT (Information tchanology)</h3>
						<span>BIT in Nepal has ability to change the current structure of information technology in Nepal. On the completion of this course one can face the problems of development and growth of information technology. BIT is introduced in Nepal to accept the globally changing information technology and to produce the IT professionals.  <br><br> 
                           The main objectives of BIT in Nepal are:
                        <ul>   
                            <li>To give knowledge and skills of changing information technology.
                            <li>Give knowledge to analyze, develop, design and implement computer-based systems.
                            <li>To develop skills in student to accept the rapidly changing information technology.
                            <li>Provides knowledge and skills in software development, web designing and development and many more fields related to IT.
                            <li>Provides foundation for further studies leading to MIT, MCA, MS computer science and MBA.


                      </ul>

                        </span> <br><br>
                        <span> Some of the places where there is job scope for CA professionals are as follows:                      
                          <ul>
                             <li>Analyst/Programmer
                            <li>IT Manager
                            <li>System Programmer
                            <li>System Analyst/ Designer
                            <li>Interactive Digital Media Specialist
                            <li>Web Administrator/ Developer
                            <li>Software Engineering
                            <li>Data Communication Engineering
                    ...
                    <span> Top Colleges:                     
                          <ul>
                            <li>College of Information technology and engineering, Kathmandu
                            <li>Kantipur City College, Kathmandu
                            <li>White House Institute of Science and Technology
                            <li>KIST college
                            <li>Aryan School of Engineering
                            <li>Asian Institute of Technology and Management
