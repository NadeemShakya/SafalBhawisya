...
<div class = "listDiv" style = "height:850px;">
                    ...
                    <div class = "listDivText">
                        ...
                        <span> <br><br> 
                           The main objectives of Computer Engineering in Nepal are:
                            <ul>
                               <li> Work closely with network support staff to identify and take care of network bugs, and design network expansions.
                               <li> Support the IP PBX system and work closely with the development team to create new mobile apps as needed.
                                <li>Offer technical support to the executive staff for internal network functions and any Internet-enabled applications.
                                <li>Monitor the company's cloud storage accounts to ensure they remain protected and secure from potential hacking threats.
                                <li>Develop network test routines that help the Network Architecton the entire company platform.
                            </ul>

                        </span> <br><br>
                        <span> Some of the areas where there is job scope for Computer Engineeringprofessionals are as follows:
                        <ul>
                            <li>Application Analyst
                            <li>Business Analyst
                            <li>Data Analyst
                            <li>Database Administrator
                            <li>Games Developer
                            <li>Information System Manager
                            <li>IT Consultant
                            <li>Multimedia Programmer
                            <li>Software Engineer
                            <li>System Analyst
                            <li>UX Analyst
                            <li>Web Designer
                            <li> Web Developer
                           <li> Digital Copywriter
                            <li>IT Sales Professional
