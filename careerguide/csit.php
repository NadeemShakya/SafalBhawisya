			...
			<div class = "mainDiv">
				<div class = "listDiv" style = "height:500px;">
					...
					<div class = "listDivText">
						<h3>B.Sc. CSIT</h3>
						<span>
                            After completing the Bsc.CSIT program of TU, students have opportunities to get job in many fields related to the computer science and modern information technology. After completing this course, if one has enough knowledge to tackle problems of changing technology then he needs to have no worry about getting job. There are many elective courses in this program so one can build his future in one of many fields. Bsc.CSIT graduates have opportunities to build careers at different government and non-government institutions, software and computer networking companies, private and public organizations as IT experts and more industries wherever there is a need of computer science and information technology professionals.
                            <br><br>
                            <u><b>Few of the job titles that a Bsc.CSIT graduates can acquire are given below:</b></u> 
                            <br>
                            <ul>
                                <li>Web developer and web designer</li>
                                <li>Software engineers and application developers</li>
                                <li>IT manager/ officer</li>
                                <li>Database and network administrators</li>
                                <li>Project managers</li>
                                <li>Search engine optimization officers</li>
                                <li>Technical content writers</li>
                                <li>Cryptographers</li>
                                <li>Telecommunication engineers</li>
                                <li>Computer system analysts</li>
                                <li>Information system analysts</li>
