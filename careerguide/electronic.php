            ...
            <div class = "mainDiv">
                <div class = "listDiv" style = "height:850px;">
                    ...
                    <div class = "listDivText">
                        ...
                        <span>Electronics and Communication Engineers are responsible to apply techniques and skills to analyze and design complex electronics and communication systems.Electronics is at the heart of the new industrial revolution. Recent innovations in the field of electronics and communication have led to rapid growth in areas such as mobile communications, high-quality audio, digital cameras, multimedia, and Internet. <br><br> 
                         Some of the objective of electronic Engineering program are:
                        <ul>   
                           <li>Technically competent in service, repair and maintenance of audio video equipment.
                           <li> Effective in communication and capable to work in a team.
                           <li> Ethically and socially responsible for the development of country and community.
                           <li> Able to demonstrate entrepreneurship skills and lifelong learning for successful career.
                           <li> Able to adapt themselves with new technological challenges in relevant field.
                        ...
                        <span> Some of the places where there is job scope for Electronic Engineering professionals are as follows:                      
                          <ul>
                            <li>Telecommunications providers – mobile phones, radio, TV and satellite companies
                            <li>Manufacturers and providers of PCs, tablets and ATM machines
                            <li>Scientific research – acoustics, optics, physics and nanotechnology
                            <li>Medical device and medical instrument manufacturers
                            Aviation and aerospace companies
                            <li>The manufacturing sector – programmable logic controls (PLCs) and industrial machinery developers
