			...
			<div class = "mainDiv">
				<div class = "listDiv" style = "height:850px;">
					...
					<div class = "listDivText">
                        ...
                        <ul>   
                        <li>In Government or private hospitals</li>
                       <li>In Nursing homes/clinics/health departments</li>
                       <li>In medical services of the army, navy and air force, under the Ministry of Defense</li>
                       <li>In charitable institutions</li>
                       <li>In medical colleges and training institutes as teachers</li>
                       <li>In research institutes and medical colleges as researchers</li>
                       <li>In the industrial sector</li>
                       <li>Private practice/ self-employment</li>
                       <li>In Government or private hospitals</li>
                       <li>In Nursing homes/clinics/health departments</li>
                       <li>In medical services of the army, navy and air force, under the Ministry of Defense</li>
                       <li>In charitable institutions</li>
                       ...
                       <li>Private practice/ self-employment</li>
                        ...
                        <ul>
                             <li>General Practitioner or Physician</li>
                             <li>  General Surgeon</li>
                             <li>  Anaesthetist or Anaesthesiologists</li>
                             <li>  Psychiatrist</li>
                             <li>  Neurologist</li>
                             <li>  Pediatrician</li>
                             <li>  Ophthalmologist or Eye Specialist</li>
                             <li>  Pathologist</li>
                             <li>  Cardiologist</li>
                             <li>  Gynaecologist-Obstetrician</li>
                             <li>  Dermatologist</li>
                             <li>  Orthopaedist</li>
                             <li>  Gastroenterologist</li>
                             <li>  Radiologist</li>
                             <li>  ENT specialist</li>
                             <li>  Tuberculosis Specialist</li>
                             <li>  Venereologist</li>
