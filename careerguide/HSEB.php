			...
			<div class = "mainDiv">
				<div class = "listDiv">
					...
					<div class = "listDivText">
						<h3>Science</h3>
						<span>Science is related to research and is commonly organized by academic and research institutions as well as government agencies and companies. The practical impact of scientific research has led to the emergence of science policies that seek to influence the scientific enterprise by prioritizing the development of commercial products, armaments, health care, and environmental protection.</span> <br><br>
						<label>Course Duration </label>
						<span>2 Years</span> <br>
					</div>
					<button onclick = "document.location.href = 'science.php'">View Course</button>
				</div>
                <div class = "listDiv">
                    <div class = "listDivImg">
                        <img src="../image/management.jpeg" alt="please_reload">
                    </div>
                    <div class = "listDivText">
                        <h3>Management</h3>
                        <span>Management is two years course and it has been offered as one of the faculties. This course provides the basic principles and knowledge about the management stream. This course of higher secondary level aims to set a base for students and motivates them to build their career in the management field. In this level, students are equipped with the necessary skills in order to prepare them for adapting to any type of situations in the business market. This course also provides managerial skills to the students making them more responsible and successful as a business persona. </label>
                        </span> <br><br>

                        <label>Course Duration </label>
                        <span>4 Years</span> <br>
                    </div>
                    <button onclick = "document.location.href = 'manage.php'">View Course</button>
                </div>
                <div class = "listDiv">
                    <div class = "listDivImg">
                        <img src="../image/humanities.jpeg" alt="please_reload">
                    </div>
                    <div class = "listDivText">
                        <h3>Humanities</h3>
                        <span>Humanities are academic disciplines that study aspects of human society and culture. In the renaissance, the term contrasted with divinity and referred to what is now called classics, the main area of secular study in universities at the time. Today, the humanities are more frequently contrasted with natural, and sometimes social, sciences as well as professional training</span> <br><br>
                        <label>Course Duration </label>
                        <span>2 Years</span> <br>
                    </div>
                    <button onclick = "document.location.href = 'science.php'">View Course</button>
