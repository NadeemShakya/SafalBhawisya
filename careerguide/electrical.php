            ...
            <div class = "mainDiv">
                <div class = "listDiv" style = "height:850px;">
                    ...
                    <div class = "listDivText">
                        ...
                        <span>Electrical engineers focus in the study of electronic devices and circuits that are the basic building blocks of complex electronic systems. Others study power and the generation, transmission, and utilization of electrical energy. A large group of electrical engineers studies the application of these complex systems to other areas, including medicine, biology, geology, and ecology. Still another controls, telecommunications, wireless communications, and signal processing <br><br> 
                         Some of the objective of Electrical Engineering program are:
                        <ul>   
                           <li>Be successful in understanding, formulating, analyzing and solving a variety of electrical engineering problems
                           <li> Be successful in designing a variety of engineering systems,products or experiments
                           <li> Be successful in careers and/or graduate study in engineering or other areas such as, business, medicine and law
                           <li> Have the ability to assume leadership and entrepreneurial positions
                           <li> Successfully function and communicate effectively, both individually and in multi-disciplinary teams
                           <li> Understand the importance of lifelong learning, ethics and professional accountability
                        ...
                        <span> Some of the places where there is job scope for Electrical Engineering professionals are as follows:                      
                          <ul>
                            <li>Evaluates electrical systems, products, components, and applications by designing and conducting research programs.
                            <li>Confirms system's and components' capabilities by designing testing methods; testing properties.
                            <li>Develops manufacturing processes by designing and modifying equipment for building and assembling electrical components.
                           <li> Assures product quality by designing electrical testing methods; testing finished products and system capabilities.
                            <li>Prepares product reports by collecting, analyzing, and summarizing information and trends.
                            <li>Provides engineering information by answering questions and requests.
                            <li>Maintains product and company reputation by complying with federal and state regulations.
                            <li>Keeps equipment operational by following manufacturer's instructions and established procedures; requesting repair service.
                            <li>Maintains product data base by writing computer programs; entering data.
                            <li>Completes projects by training and guiding technicians.
