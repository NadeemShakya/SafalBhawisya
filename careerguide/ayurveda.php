...
<body>
			...
			<div class = "mainDiv">
				<div class = "listDiv" style = "height:430px;">
					...
					<div class = "listDivText">
						...
						<span>After completing degree course in Ayurveda, one can have following options:</span> 
                        <ul>
                            <li>Private Practice in Nepal</li>
                            <li>Further Studies</li>
                            <li>Job Opportunities in Ayurveda hospitals and medicals After BAMS</li>
                            <li>Different Business options</li>
                            <li>Cultivation of Medicinal Plants and business of medical herbs( with permission from Nepal Government and governing bodies) </li>
                            <li>Pharmaceutical Industry</li>
                            <li>Corporate Fitness Expert</li>
