				...
				<div class = "listDiv" style = "height:300px;">
					...
					<div class = "listDivText">
						<h3>Bachelors in Public Health</h3>
		                  ...
		                  <span>
                      The completion in BPH opens up a variety of scopes for the BPH graduates in Nepal. The ones after passing BPH in Nepal can work as Public Health Officer in the government sector. They have the opportunities in becoming the Chief Public Health Officer.  Not only this there are a lot of organizations that feel the need of these BPH graduates. Several types of governmental organizations or non-governmental organizations like the health agencies. hospitals,schools and institutions etc require these professionals for working with the  local community and individuals, working primarily with the school teachers for awarenes as well as basic health facilities, administrating health education services  and preparing health workers in public health fields. <br><br>
                      Apart from these domestic level programmes excellent BPH professionals have got good scopes in the international organizations like World Health Organization (WHO), United Nations Children’s Fund and several other organizations like these.
