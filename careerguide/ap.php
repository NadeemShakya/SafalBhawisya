			...
			<div class = "mainDiv">
				<div class = "listDiv" style = "height:500px;">
					...
					<div class = "listDivText">
						...
						<span>Undergraduate degree in applied is a gateway to an array of careers. Graduates can find work in diverse areas of engineering, photonics/optoelectronics, semiconductors, research& development and communication. They have the option to work as:<br>
                       ...
                       <ul>
                           ...
                           <li>Acoustics and Ultrasonic</li>
                           <li>Instrumentation Designer</li>
                           <li>Biophysics and Medical Physics</li>
                           <li>Product Design and Development</li>
                           <li>Computing & Software Development</li>
                           <li>Computational Physics and Modeling</li>
                           <li>Semiconductor Devices and Microelectronics</li>
                       </ul>
