			...
			<div class = "mainDiv">
				<div class = "listDiv">
					<div class = "listDivImg">
						<img src="../image/engineering.jpeg" alt="please_reload">
					</div>
					<div class = "listDivText">
						<h3>Engineering</h3>
						<span>Engineering is the creative application of science, mathematical methods, and empirical evidence to the innovation, design, construction, operation and maintenance of structures, machines, materials, devices, systems, processes, and organizations. The discipline of engineering encompasses a broad range of more specialized fields of engineering, each with a more specific emphasis on particular areas of applied mathematics, applied science, and types of application. </span> <br><br>
						<label>Course Duration </label>
						<span>4 Years</span> <br>
					</div>
					<button onclick = "document.location.href = 'engineering.php'">View Course</button>
				</div>
			</div>
