			...
			<div class = "mainDiv">
				<div class = "listDiv" style = "height:500px;">
					...
					<div class = "listDivText">
						<h3>B.Sc. Nursing</h3>
						<span>What can be any noble profession than nursing where you earn good salary and feel satisfied by helping those are sick and unhealthy. One of the most important professions in health care is nursing and nurses are the integral player who has very diverse role to play. Nurses can find employment in the areas like:<br>
                            <ul>
                                <li>Hospitals and health centers</li>
                                <li>Nursing homes</li>
                                <li>Clinics and health departments</li>
                                <li>Orphanage and children and old house care</li>
                                <li>Military and sports</li>
                                <li>Schools and colleges</li>
                                <li>Industry and corporate house</li>
                                <li>Medicinal centers</li>
                                <li>Teacher and educators</li>
                            </ul>
                            Not only this they can also pursue their further study in different reputed universities of foreign countries. B.Sc. Nursing has very high demand in the foreign countries where they are paid very lucrative salary.
                            <br>
