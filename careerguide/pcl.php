...
<body>
            ...
            <!-- eha bata suru hunxa -->
            <div class = "mainDiv">
<div class = "listDiv" style = "height:900px;">
                    <div class = "listDivImg">
                        <img src="../image/PCL.jpg" alt="please_reload">
                    </div>
                    <div class = "listDivText">
                        <h3>PCL</h3>
                        <span>The PCL Nursing course is based on the job required to perform by the Staff Nurse at different levels in public and private sector’s health field in relation to nursing jobs. The curriculum is designed to provide knowledge and skills focusing on nursing related occupation to be carried out by intermediate level nurses. In total of the three years of PCL nursing course; the first year course is offered focusing on basic nursing care in hospital and in the community. <br><br> 
                           The main objectives of PCL in Nepal are:
                            <ul>
                              <li>Utilize basic nursing knowledge (pain management, basic technical skills, health teaching, and communication skills) to care the sick and injured people.
                                <li>Apply sound body of knowledge base on care of individual, family and community.
                               <li> Draw on content from other science and humanities relevant to nursing practice.
                               <li> Utilize nursing process in care if individual, family and community.
                               <li> Assume leadership role in hospital and community setting.
                                <li>Mobilize the community to promote their health and prevent diseases in the community.
                                
                                <li>Apply knowledge and critical thinking skills in their nursing practice.
                                <li>Develop and coordinate partnership relationship with other members to ensure continuity of health and illness care for clients.
                               <li> Accept responsibilities and accountability for their nursing practice.
                                
                                <li>Conduct a simple research and know how to locate research findings in nursing and related field to inform their nursing practice.


                            </ul>

                        </span> <br><br>
                        <span> Some of the areas where there is job scope for PCL Engineeringprofessionals are as follows:
                        <ul>
                            <li>Hospitals
                            <li>NHS trusts
                    ...
                    <span> Top Colleges:                     
                          <ul>
                           <li> Asian College of Advance Studies
                           <li> B.P. Koirala Institute of Health Sciences
                           <li> Chitwan Medical College
                           <li> College of Medical Sciences
                           <li> Everest College of Nursing
                           <li> Institute of Medicine (IOM)
                           <li> Kathmandu Medical College
                           <li> LA College, Hattiban
                           <li> National Academy for Medical Sciences
