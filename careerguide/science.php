			...
			<div class = "mainDiv">
				<div class = "listDiv">
					<div class = "listDivImg">
						<img src="image/pgroup.jpeg" alt="please_reload">
					</div>
					<div class = "listDivText">
						<h3>Physics</h3>
						<span>Students belonging to the physical or math group might take up engineering courses like civil engineering, computer or software engineering or other engineering faculties. S/he can even switch faculties and go on to the sector of IT (information technology). One could study BIT (Bachelor in Information Technology), BIM (Bachelor in IT and Management), BCIS, BCA, B.Sc. in computer science, etc. S/he may even go on to the Management sector and study BBS (three years), BBA (four years), BHM (Bachelor in Hotel Management), BTTM (Bachelor in Travel and Tourism Management), etc.</span> <br><br>
						<label>Course Duration </label>
						<span>4 Years</span> <br>
					</div>
					<button onclick = "document.location.href = 'physics.php'">View Course</button>
				</div>
                <div class = "listDiv">
                    <div class = "listDivImg">
                        <img src="image/bgroup.jpeg" alt="please_reload">
                    </div>
                    <div class = "listDivText">
                        <h3>Biology</h3>
                        <span>Student belonging to biology group can take a medical career. If s/he can not become a doctor, they could take up B.Sc. in micro-biology, pharmacology, medical technology, genetic engineering, bio-chemistry etc. S/he may even go on to the Management sector and study BBS (three years), BBA (four years), BHM (Bachelor in Hotel Management), BTTM (Bachelor in Travel and Tourism Management), etc.</span> <br><br>
                        <label>Course Duration </label>
                        <span>4-5 years Years</span> <br>
                    </div>
                    <button onclick = "document.location.href = 'biology.php'">View Course</button>
                </div>
