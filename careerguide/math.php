			...
			<div class = "mainDiv">
				<div class = "listDiv" style = "height:400px;">
					...
					<div class = "listDivText">
						<h3>Bachelor in Mathematical Sciences (BMathSc)</h3>
						<span>
                        If there is one ﬁeld where career prospects are abundant because the demand exceeds supply, it is Actuarial Science. <br>
                        The course is globally recognized with mutual exemptions with a lot of other international actuarial institutes. <br>
                        Traditionally, actuaries were found only in the life-insurance sector. However, with the opening up of the economy they are wanted by general insurance, health insurance, reinsurance companies, pensions and employee beneﬁts, investment consultancies, risk management, banks, stock exchanges, private and government agencies. This is one ﬁeld where career prospects are abundant because the demand exceeds supply even in the world.<br>
                        <ul>
                            <li>Data Analyst</li>
                            <li>Financial Analyst</li>
                            <li>IT or Computing Analyst</li>
                            <li>Mathematical Modeler</li>
