...
<body>
            ...
            <div class = "mainDiv">
                <div class = "listDiv" style = "height:400px;">
                    ...
                    <div class = "listDivText">
                        ...
                        <span>
                            The environment science has immense and lucrative scope in current scenario. With the increase in importance of environment among people nationally and internationally, the job horizon of environment science graduates have also increased. The undergraduates in the environment can get job in various environment related organizations, NGO/INGO's and government departments working in the field of environment. Undergraduates can get jobs as researchers, teachers, supervisor, conservationists, campaigner, consultant, journalist, etc in the field of environment. The job of environment graduates requires adequate traveling. So, the work is very interesting and relaxing. You can work as well as enjoy the fantasy of nature simultaneously. Unlike other sciences, it deals with integrated aspects of earth, biology and physical science. The environment graduates can also work in different positions in Environment Impact Assessment (EIA) team. Moreover, option for further study is also available for undergraduates. This subject has huge demand in the developed country and students can study and earn them.
