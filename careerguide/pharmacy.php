...
<body>
			...
			<div class = "mainDiv">
				<div class = "listDiv" style = "height:260px;">
					<div class = "listDivImg">
						<img src="image/pharmacy.jpeg" alt="please_reload">
					</div>
					<div class = "listDivText">
						<h3>Bachelor of Pharmacy</h3>
						<span>In Nepal, there is a good scope of pharmacy because in the context of 2057-2067 only 4% of doctors, nurses are there to attend the patients. As, in Nepal there are many places where chemical drugs i.e. medicines are not available till today’s date. So, we always need pharmacy and pharmacist to fulfill the lack of medicines and clinics. In fact, Pharmacist have provision to open their own clinic therefore, pharmacists have good scope in Nepal. The salary status is also good for pharmacist, if pharmacist do jobs in any drug company, hospitals, clinics in Nepal. The salary is about NRS. 30,000 to NRS. 40,000 per month. In short, pharmacist and study of pharmacy is collectively important and scope in Nepal.</span> 
